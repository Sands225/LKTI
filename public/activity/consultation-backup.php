					...
					<div
						...
						<div class="flex w-full">
							...
							<div class="w-[5%] my-auto">
								<button onclick="return sendChat()" id="send" name="send">
									<img
                ...
                $.ajax({
                    ...
                    data: { name: "John", location: "Boston" }
                        ...
                        for (let i = 0; i < respon['data'].length; i++) {
                            ...
                            chat += '<div class="flex w-full mt-2 space-x-3 max-w-md '+posisi+'"><div><div class="'+warna+ ' '+fontColor+ ' p-3 rounded-r-lg rounded-bl-lg"><p class="text-sm">'+respon['data'][i].pesan+'</p></div><span class="flex text-xs text-gray-500 leading-none '+posisi+'"> '+getDate(respon['data'][i].timestamp)+' </span></div></div>';
